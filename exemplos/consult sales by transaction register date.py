...
registration_date_start = "2020-11-01"
registration_date_start = "2020-11-20"
page   = None
status = 1

if code:
	## To officially consult
	pprint(hubsale.get_sale_by_date(registration_date_start, registration_date_end, status, page))
	## To test consult
	pprint(hubsale.get_sale_by_date(registration_date_start, registration_date_end, status, page, test=True))
else:
	print(message)